...
public class CloseDialogAction extends DialogActionWithDetails {
    ...
    public CloseDialogAction(final FulfillmentState fulfillmentState) {
        super("Close");
    ...
    public CloseDialogAction(final FulfillmentState fulfillmentState, final Message message) {
        this(fulfillmentState);
        setMessage(message);
    }

    public CloseDialogAction(final FulfillmentState fulfillmentState, final Message message, final ResponseCard responseCard) {
        this(fulfillmentState, message);
        setResponseCard(responseCard);
    }

    public CloseDialogAction(final FulfillmentState fulfillmentState, final ResponseCard responseCard) {
        this(fulfillmentState);
        setResponseCard(responseCard);
    }
