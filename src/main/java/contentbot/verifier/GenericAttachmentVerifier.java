...
import contentbot.domain.Button;
...
public class GenericAttachmentVerifier extends AbstractVerifier<GenericAttachment> {
    ...
    private final ButtonVerifier buttonVerifier = new ButtonVerifier();

    @Override
    public void verify(final GenericAttachment genericAttachment) {
        ...
        if (genericAttachment.getButtons() != null) {
            ...
            for (final Button button : genericAttachment.getButtons()) {
