...
import contentbot.domain.GenericAttachment;
...
public class ResponseCardVerifier extends AbstractVerifier<ResponseCard> {
    ...
    private final GenericAttachmentVerifier genericAttachmentVerifier = new GenericAttachmentVerifier();

    @Override
    public void verify(final ResponseCard responseCard) {
        ...
        for (final GenericAttachment genericAttachment : responseCard.getGenericAttachments()) {
